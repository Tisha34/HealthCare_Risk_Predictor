...
# Problem Statement:
NovaGen Research Labs conducts large-scale health studies but lacked a reliable system to consistently classify individuals as healthy or high health risk.

This project aims to build an Intelligent Health Risk Classification System using Machine Learning algorithms to predict health outcomes based on physiological, lifestyle, and medical history data.

# Project Workflow:
Performed EDA to identify health risk patterns and lifestyle trends

Cleaned and preprocessed healthcare data.

Applied Feature Engineering and Feature Scaling techniques
